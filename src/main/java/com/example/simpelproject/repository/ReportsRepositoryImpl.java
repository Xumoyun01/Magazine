...
public class ReportsRepositoryImpl {
    ...
    public Page<Reports> getAdvancedSearch(Map<String, String> params) {
        ...
        String strQuery = "select u from Reports u where 1=1";
        String countQuery = "select count(reportsId) from Reports u where 1=1";
    ...
    private StringBuilder buildParams(Map<String, String> params) {
        ...
        if (params.containsKey("reportsId")) {
            builder.append(params.get(" AND reportsId=: reportsId"));
        }
        ...
        if (params.containsKey("prodPresent")) {
            builder.append(params.get(" AND prodPresent= :prodPresent"));
        }
        return builder;
    }
